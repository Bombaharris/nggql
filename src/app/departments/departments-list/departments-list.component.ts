    ...
    if (departmentForm) {
      ...
      if (this.editedDepartment) {
        this.departmentsAdapterService
          .submitDepartment<UpdateDepartmentsGQL>(
            departmentForm,
      ...
      this.departmentsAdapterService
        .submitDepartment<CreateDepartmentsGQL>(departmentForm)
        .subscribe(
          () => {
            this.notification.create(
              'success',
